...
int Menu()
{
	...
	do
	{
		...
		printf("\n\n\t1: |EASY| - not including repetition & blanks");
		printf("\n\n\t2: |NORMAL| - with repetition & NO blanks");
		printf("\n\n\t3: |HARD| - with repetition & blanks");
		printf("\n\n\t4: |EXIT|");
		printf("\n_________________________________________________________________");
...
void normalMode()
{
	...
	while(blackPeg != 4 && timesPlayed != NumberOfTries)
	{
		...
		{
			printf("\nNo Tries Left unfortunatly! You Lose!\n ");
			printf("Press any key to return to menu: ");
			_getch();
		}
